 ...
 */
export declare function chain<TSource, TResult>(source: AsyncIterable<TSource>, selector: (source: AsyncIterable<TSource>) => AsyncIterable<TResult>): AsyncIterableX<TResult>;
