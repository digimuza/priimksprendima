...
const asyncIterableReadableStream = (() => {
    ...
    let createFirstTime = (source, opts) => {
    ...
    let createAsyncIterableReadableStreamEveryOtherTime = (source, opts) => {
...
export function toDOMStream(source, options) {
    ...
    return asyncIterableReadableStream(new UnderlyingAsyncIterableByteSource(source[Symbol.asyncIterator]()), options);
}
