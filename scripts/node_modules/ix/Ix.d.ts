...
export declare type GroupedIterable<TKey, TValue> = GroupedIterable<TKey, TValue>;
export declare type GroupedAsyncIterable<TKey, TValue> = GroupedAsyncIterable<TKey, TValue>;
