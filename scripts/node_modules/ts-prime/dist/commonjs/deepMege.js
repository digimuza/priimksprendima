...
function recursiveMerge(a, b) {
    if (guards_1.isObject(a) && guards_1.isObject(b)) {
        var output = __assign({}, a);
        var keys = uniq_1.uniq(__spreadArrays(Object.keys(a), Object.keys(b)));
...
exports.deepMergeLeft = deepMergeLeft;
/**
 ...
 * @returns {T}
 */
function deepMergeRight(target) {
    var sources = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        sources[_i - 1] = arguments[_i];
    }
    var output = clone_1.clone(target);
...
exports.deepMergeRight = deepMergeRight;
