...
var deepMege_1 = require("./deepMege");
describe('mergeDeepLeft and mergeRight tests', function () {
    test('basic', function () {
        ...
        expect(deepMege_1.deepMergeLeft(data1, data2)).toEqual({
            a: 1,
            d: {
                d: fn,
                e: {
        ...
        expect(deepMege_1.deepMergeRight(data1, data2)).toEqual({
            a: 2,
            d: {
                d: fn,
                e: {
    ...
    test('Expecting correctly merged arrays', function () {
        expect(deepMege_1.deepMergeLeft(d1, d2)).toEqual({
            a: [1, 2, 3, { a: 1 }, 7, { a: 1 }, { a: 2 }],
        });
        expect(deepMege_1.deepMergeRight(d1, d2)).toEqual({
    ...
    test('Complicated example', function () {
        ...
        expect(deepMege_1.deepMergeLeft(source1, source2)).toEqual({
            propA1: [1, 2, 3],
            propA2: [2],
            propA3: [3, 2, 1],
            propB1: true,
