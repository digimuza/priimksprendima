 ...
 * @category Array
 */
export declare function reject<T>(items: readonly T[], fn: Pred<T, boolean>): readonly T[];
/**
 * Reject the elements of an array that meet the condition specified in a callback function.
 * @param items The array to reject.
 * @param fn the callback function.
...
export declare namespace reject {
    ...
    function indexed<T, K>(fn: PredIndexed<T, boolean>): (array: readonly T[]) => readonly K[];
